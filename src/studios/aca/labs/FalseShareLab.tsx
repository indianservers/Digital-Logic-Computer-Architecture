...
export function FalseShareLab() {
  ...
  return (
    <LabChrome lab="false-sharing" kicker="Labs > Lab 20" title="Lab 20 — False Sharing Visualizer" subtitle="See how independent variables in one cache line create unnecessary coherence traffic, and how padding fixes it." badge="RISC-V (5-Stage Pipeline)">
