...
export const STUDIOS: StudioInfo[] = [
  ...
  { id: "hierarchy", title: "Memory Hierarchy", phase: 5, path: "/studios/hierarchy", summary: "Registers, caches, RAM, and storage with a live access trace.", topics: ["locality", "amat", "cache"], active: true },
  { id: "vm", title: "Virtual Memory", phase: 5, path: "/studios/vm", summary: "Pages, TLBs, two-level tables, and protection faults.", topics: ["virtual memory", "tlb", "page fault"], active: true },
  { id: "io", title: "I/O Architecture", phase: 5, path: "/studios/io", summary: "Memory-mapped I/O, isolated I/O, and programmed polling.", topics: ["memory-mapped", "polling"], active: true },
  { id: "interrupts", title: "Interrupts & DMA", phase: 5, path: "/studios/interrupts", summary: "Vectors, priority, exceptions, and block transfer.", topics: ["interrupt", "dma", "exception"], active: true },
  { id: "bus", title: "Bus Architecture", phase: 5, path: "/studios/bus", summary: "Address, data, control, arbitration, and bandwidth.", topics: ["bus", "arbitration", "bandwidth"], active: true },
  { id: "parallel", title: "Parallel Processing", phase: 5, path: "/studios/parallel", summary: "Issue width, renaming, the reorder buffer, SIMD, and SMT.", topics: ["superscalar", "ilp", "simd"], active: true },
  { id: "multicore", title: "Multicore & Coherence", phase: 5, path: "/studios/multicore", summary: "Shared memory, MSI, MESI, and false sharing.", topics: ["mesi", "msi", "false sharing"], active: true },
  { id: "accelerator", title: "AI Accelerator / TPU / NPU", phase: 6, path: "/architecture/accelerator", summary: "MAC units, systolic arrays, quantization, and neural execution.", topics: ["mac", "systolic", "tpu", "npu"], active: true },
  { id: "hetero", title: "Heterogeneous Computing", phase: 6, path: "/architecture/hetero", summary: "CPU, GPU, NPU, and DSP roles, routing, and offload.", topics: ["offload", "scheduler", "unified memory"], active: true },
  { id: "soc", title: "SoC Architecture Explorer", phase: 6, path: "/architecture/soc", summary: "Floorplan, NoC, system cache, and power domains.", topics: ["soc", "noc", "isp"], active: true },
  { id: "cpu8", title: "Educational 8-bit CPU", phase: 6, path: "/architecture/cpu8", summary: "Accumulator datapath, teaching ISA, and clock-by-clock execution.", topics: ["8-bit", "assembler", "micro-op"], active: true },
  { id: "cpu16", title: "Educational 16-bit CPU", phase: 6, path: "/architecture/cpu16", summary: "LogicLab-16 register file, CALL/RET, stack, and a simple interrupt.", topics: ["16-bit", "stack", "interrupt"], active: true },
  { id: "mips", title: "MIPS Architecture Explorer", phase: 7, path: "/architecture/mips", summary: "Teaching MIPS32 formats, decoder, datapath, and pipeline overview.", topics: ["mips", "r-type", "datapath"], active: true },
  { id: "riscv-lab", title: "RISC-V Processor Lab", phase: 7, path: "/architecture/riscv", summary: "Bit-accurate RV32I assembler, immediates, datapath, and hazards.", topics: ["risc-v", "rv32i", "assembler"], active: true },
  { id: "arm", title: "ARM Architecture Explorer", phase: 7, path: "/architecture/arm", summary: "AArch64-oriented teaching view of registers, load/store, calls, and EL0–EL3.", topics: ["arm", "aarch64", "neon"], active: true },
  { id: "x86", title: "x86 Architecture Explorer", phase: 7, path: "/architecture/x86", summary: "Variable-length encodings, addressing, micro-ops, and an OOO backend sketch.", topics: ["x86", "micro-op", "addressing"], active: true },
  { id: "compare-isa", title: "ISA Comparison Explorer", phase: 7, path: "/architecture/compare", summary: "Neutral RISC-V, ARM, and x86 comparison. No ranking.", topics: ["isa", "encoding", "comparison"], active: true },
  { id: "mobile", title: "Modern Mobile SoC Explorer", phase: 7, path: "/architecture/mobile", summary: "Generic P/E cores, GPU, NPU, ISP, thermal, and modem concept.", topics: ["soc", "npu", "thermal"], active: true },
  { id: "desktop", title: "Modern Desktop CPU Explorer", phase: 7, path: "/architecture/desktop", summary: "Generic package, caches, DDR, PCIe, boost, and package power.", topics: ["desktop", "boost", "pcie"], active: true },
  ...
  { id: "builder", title: "Build Your Own CPU", phase: 8, path: "/architecture/builder", summary: "Construct a processor from registers, ALU, memory, and a custom ISA.", topics: ["cpu builder", "isa", "assembler", "datapath"], active: true },
  { id: "sandbox", title: "Computer Architecture Sandbox", phase: 8, path: "/architecture/sandbox", summary: "Combine gates, datapaths, caches, CPUs, and coherence in one workspace.", topics: ["sandbox", "circuit", "multicore"], active: true },
];
